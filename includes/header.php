...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="/noteplus/design/assets/images/favicon.ico" />
    <link rel="stylesheet" href="/noteplus/design/assets/css/backend-plugin.min.css?v=1.0.0">
    <link rel="stylesheet" href="/noteplus/design/assets/css/backend.css?v=1.0.0">
    <link rel="stylesheet" href="/noteplus/design/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css">
    <link rel="stylesheet" href="/noteplus/design/assets/vendor/line-awesome/dist/line-awesome/css/line-awesome.min.css">
    <link rel="stylesheet" href="/noteplus/design/assets/vendor/remixicon/fonts/remixicon.css">
    <link rel="stylesheet" href="/noteplus/design/assets/vendor/@icon/dripicons/dripicons.css">
</head>
            ...
            <div class="iq-navbar-custom">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                        ...
                        <a href="/noteplus/design/backend/index.html" class="header-logo">
                            ...
                            <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                    ...
                                    <div class="iq-search-bar iq-sub-dropdown dropdown-menu" aria-labelledby="h1-dropdownSearch">
                                        <form action="#" class="searchbox p-2">
                                            <div class="form-group mb-0 position-relative">
                                                <input type="text" class="text search-input font-size-12" placeholder="type here to search/noteplus/design.">
                                ...
                                <li class="caption-content">
                                    <a href="#" class="iq-user-toggle d-flex align-items-center justify-content-between" id="h-dropdownMenuButton001" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="/noteplus/design/assets/images/user/1.jpg" class="img-fluid rounded avatar-50" alt="user">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right w-100 border-0 py-2" aria-labelledby="h-dropdownMenuButton001">
                                        ...
                                        <a class="dropdown-item" href="/noteplus/design/app/user-privacy-setting.html">
                                            <i class="las la-user-shield font-size-20 mr-1"></i>
                                            <span>Privacy Settings</span>
                                        </a>
                                        <hr class="my-1">
                                        <a class="dropdown-item" href="/noteplus/design/backend/index.html">
